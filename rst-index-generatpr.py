        ...
        for n in range(1, lines_count):
            ...
            if(nextLine == len(nextLine) * nextLine[0]):
                ...
                if nextLine[0] == "=":
                    ...
                    print("h2")
                    h2_count = h2_count + 1
                    output_file.write("   -  " + str(h1_count) + "." + str(h2_count) + " `" + thisLine + "`_\n\n")  # writing heading link
                    ...
                    print("h3")
                    h3_count = h3_count + 1
                    output_file.write("      -  " + str(h1_count) + "." + str(h2_count) + "." + str(h3_count) + " `" + thisLine + "`_\n\n")  # writing heading link
                    ...
                    print("h4")
                    h4_count = h4_count + 1
                    output_file.write("         -  "  + str(h1_count) + "." + str(h2_count) + "." + str(h3_count) + "." + str(h4_count) + " `" + thisLine + "`_\n\n")  # writing heading link
